...
# Cameras genericas levam ~6 s para responder o ffprobe num Orange Pi ocupado gravando; 8 s nao bastava.
TIMEOUT_TESTE_RTSP = int(os.environ.get("NVRBOX_TIMEOUT_TESTE_RTSP", "20"))
